...
function draw() {
 ...
 noStroke();
  ...
  dodge.velocityX = 0;
    ...
    text("DODGE ", 100, 600);
    text("1800", 530, 600);
    text(Math.round(speed1), 930, 600);
    text(deformation1, 1350, 600)
  ...
  if (bmw .x + 235 - wall.x < bmw.width / 2 + wall.width / 2
    ...
    text("BMW", 130, 647);
    text("615", 530, 647);
    text(Math.round(speed2), 930, 647);
    text(deformation2, 1350, 647);
    ...
    if (ford.x + 145 - wall.x <ford.width / 2 + wall.width / 2
      ...
      text("FORD", 130,750);
      text(2170, 530, 750);
      text(Math.round(speed3), 930, 750);
      text(deformation3, 1350, 750)
    ...
    if (tesla.x + 230 - wall.x < tesla.width / 2 + wall.width / 2
      ...
      text("TESLA ", 100, 700);
      text(1550, 530, 700);
      text(Math.round(speed4), 930, 700);
      text(deformation4, 1350, 700)
